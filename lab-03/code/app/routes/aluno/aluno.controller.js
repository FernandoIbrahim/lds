const alunoController = require('../../models/usuario/aluno/aluno.model');
...
async function httpPost(req, res){
    ...
    try{
        ...
        const aluno = await alunoController.create(nome, email, senha, endereco, curso, instituicao_id );
...
async function httpGetById(req, res){
    ...
    try{
        ...
        const aluno = await alunoController.findById(id);
...
async function httpPut(req, res){
    ...
    try{
        ...
        const aluno = await alunoController.update(id, nome, email, senha, endereco, curso, instituicao_id );
...
async function httpDelete(req, res){
    ...
    try{
        ...
        const deletedAluno =  await alunoController.deleteById(id);
